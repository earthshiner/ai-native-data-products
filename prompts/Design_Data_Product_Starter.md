...
[Path or filename of your organisation's Physical Storage Standard implementation, if object storage
(S3, ADLS, GCS) is in use. Write "NOT APPLICABLE" if the platform uses only block storage.]
...
mandatory content). This INSERT is typically placed at the end of the Memory module's DDL file
or as a separate seed script alongside `00-access/`.
